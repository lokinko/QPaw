...
use crate::models::{
    ...
    InteractionEventKind, LayeredMemoryItem, MemoryConsolidationJob, MemoryDocument, MemoryL0,
    MemoryL0Category, MemoryL1Concept, MemoryL1Relation, MemoryL2Event, MemoryL3Reflection,
    MemoryLayer, MemoryLayerFilter, MemoryStats, MemoryStatus, ReflectionKind, ReminderEvent,
    ReminderFeedbackPayload, WorkingMemoryItem, WorkingMemoryKind,
};
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct MemoryL0Record {
    uid: String,
    category: MemoryL0Category,
    title: String,
    summary: String,
    tags: Vec<String>,
    confidence: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct MemoryL3ReflectionRecord {
    uid: String,
    kind: ReflectionKind,
    title: String,
    insight: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct MemoryConsolidationJobRecord {
    uid: String,
    date: NaiveDate,
